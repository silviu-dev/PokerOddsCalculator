...
void create_cards(Poker_game *parent)
{
    for (int i = 1; i <= 52; i++)
    {
        ...
        if (i <= 26)
        {
            ...
            if (i <= 13) {
                strcpy(image, "image: url(:/Poker_game/inima_neagra.png);\n"
            ...
            {
                strcpy(image, "image: url(:/Poker_game/inima_rosie.png);\n"
                    "background-color: rgb(255, 255, 255);\n"
                    "text-align:top left;\n");
                if (i == 22)
                {
        ...
        else
        {
            ...
            if (i <= 39) {
                strcpy(image, "image: url(:/Poker_game/romb.png);\n"
                    "background-color: rgb(255, 255, 255);\n"
                    "text-align:top left;\n");
                if (i == 35)
                {
            ...
            {
                strcpy(image, "image: url(:/Poker_game/trefla.png);\n"
                    "background-color: rgb(255, 255, 255);\n"
                    "text-align:top left;\n");
                if (i == 48)
                {
